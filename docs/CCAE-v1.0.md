...
| Conjunto | N | Uso |
|---|---|---|
| Calibração | 15 | Ajustes no CCAE são permitidos; cada ajuste gera nova versão |
| Conformidade | 45 | Executado **uma vez**, ao final. Qualquer ajuste posterior o invalida |
