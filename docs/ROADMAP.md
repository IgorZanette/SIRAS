...
| S4 | 16–31/10 | Frutíferas (17, três fases) e erva-mate — **marco M2** | concluído — `motor/adubacao.py` cobre as 17 frutíferas em pré-plantio e crescimento, e a manutenção nos formatos taxa/tonelada (8 culturas), bespoke (amoreira-preta, mirtileiro, morangueiro, nogueira-pecã — ADR 0004 D4.7) e correspondência solo-tecido da videira (N e P; K permanece pendente por decisão do Manual, D4.6); erva-mate (3 fases + recuperação); casos ADU-11/12/15-19 conferem. Só ameixeira, macieira e pêssego/nectarina ficam fora de escopo na manutenção (teor foliar sem correspondência solo-tecido, D4.6) — pré-plantio e crescimento continuam cobertos. Pendência de dado: ADU-15 tem descasamento proposital entre entrada e esperado (ver ADR 0004 D4.7), aguardando decisão do autor antes de virar `referencia` oficial |
