...
| Contraste (`scripts/conferir_contraste.py`) | sinais e verdes de uso como componente passam o piso de 3:1; 18 pares ficam abaixo do piso, todos entre tons de verde — o script os registra como informativos para o uso atual, a conferir contra os templates antes do teste de usabilidade |
